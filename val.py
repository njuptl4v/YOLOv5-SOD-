...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp76/weights/best.pt', help='model path(s)')
    ...
    opt.save_json |= opt.data.endswith('VisDrone.yaml')
